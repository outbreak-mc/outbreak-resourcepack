...
# Скрипт ищет текстуры в path/textures, значки в path/icons и
# рамки уровней в path/levels. Создаёт все варианты книг всех
# зачарований всех уровней, накладывая картинки друг на друга
# а также создаёт для каждой из получившихся картинок 
# файл properties

path = os.path.abspath(os.path.dirname(__file__))

icons_path = os.path.join(path, "book_icons")
levels_path = os.path.join(path, "book_levels")
original_path = os.path.join(path, "enchanted_book.png")
